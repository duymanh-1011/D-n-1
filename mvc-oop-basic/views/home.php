    ...
    <main>
                ...
                <div class="row mtn-30">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="policy-item">
                            ...
                            <div class="policy-content">
                                <h6>Hoàn trả</h6>
                                <p>30 ngày để hoàn trả miễn phí</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-3">
                ...
                <div class="row row-20 mtn-20">
                    <div class="col-sm-6">
                        <figure class="banner-statistics mt-20">
                            <a href="#">
                                <img src="assets/img/product/product-5.jpg" alt="product banner">
                            </a>
                    ...
                    <div class="col-sm-6">
                        <figure class="banner-statistics mt-20">
                            <a href="#">
                                <img src="assets/img/product/product-14.jpg" alt="product banner">
                            </a>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="tab1">
                                    <div class="product-carousel-4 slick-row-10 slick-arrow-style">
                                        ...
                                        <?php if (!empty($sanPhamHienThi)) : ?>
                                            <?php foreach ($sanPhamHienThi as $sanPham) : ?>
                                                <?php
        ...
        <section class="product-banner-statistics">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="product-banner-carousel slick-row-10 slick-arrow-style">
