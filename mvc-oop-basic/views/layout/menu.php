                        ...
                        <div class="col-lg-4">
                            <div class="header-right d-flex align-items-center justify-content-xl-between justify-content-lg-end">
                                ...
                                if (isset($_SESSION['user_client'])) {
                                    ...
                                    $userMini = $userModel->getTaiKhoanFromEmail($_SESSION['user_client']);
                                    if ($userMini) {
                                        $gioHangMini = $gioHangModel->getGioHangFromUser($userMini['id']);
                                        if ($gioHangMini) {
                                            $detail = $gioHangModel->getDetailGioHang($gioHangMini['id']);
